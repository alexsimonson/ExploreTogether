...
public class InventoryUI : MonoBehaviour {
    ...
    void DrawInventoryUI(){
        ...
        for(var slot_index=0;slot_index<inventory.slots.Length;slot_index++){
            ...
            inventory.slots[slot_index].GetComponent<SlotContainer>().inventorySlot = Instantiate(inventorySlotButtonPrefab, inventory.slots[slot_index].GetComponent<SlotContainer>().transform.position, inventory.slots[slot_index].GetComponent<SlotContainer>().transform.rotation);
